...
func TestParseMixFallbackHosts(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		got, err := ParseMixFallbackHosts("10.20.0.65,kr.goodfood.com:7002,[2401:c080:1c02:aaf:5400:4ff:fe78:d01f]:7007", 7001)
		require.NoError(t, err)
		require.Len(t, got, 3)
		...
		require.Equal(t, "2401:c080:1c02:aaf:5400:4ff:fe78:d01f", got[2].Host)
